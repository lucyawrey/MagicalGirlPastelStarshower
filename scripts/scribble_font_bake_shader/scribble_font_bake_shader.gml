...
function scribble_font_bake_shader(
	...
	if (_markAsRasterEffect) {
		_new_font_data.__render_type = __SCRIBBLE_RENDER_RASTER_WITH_EFFECTS;
	}
	...
	var _new_material = __scribble_get_material(
		_new_font_name,
		__scribble_sprite_get_texture_index(_sprite, 0),
		_new_font_data.__render_type,
		undefined,
		undefined,
		_new_font_data.__bilinear
	);
