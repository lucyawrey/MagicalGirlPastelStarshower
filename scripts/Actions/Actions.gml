...
function show(_sprite_name, _position, _y_position) {
	...
	if (is_string(_position)) {
		if (_position == "center") {
			_x_pos = (global.gui_width * 0.3) - (sprite_get_width(_sprite) * 0.5);
		} else if (_position == "left") {
			_x_pos = (global.gui_width * 0.1) + (sprite_get_width(_sprite) * 0.5);
		} else if (_position == "right") {
			_x_pos = (global.gui_width * 0.5) - (sprite_get_width(_sprite) * 0.5);
		}
