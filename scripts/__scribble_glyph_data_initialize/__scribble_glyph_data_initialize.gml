...
function __scribble_glyph_data_initialize() {
	...
	for (var _i = 0x0000; _i <= 0x0009; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.SYMBOL;
	}
	...
	for (var _i = 0x0590; _i <= 0x05FF; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.R2L;
	} //Hebrew block
	for (var _i = 0x0600; _i <= 0x06FF; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.R2L_ARABIC;
	} //Arabic block
	for (var _i = 0x0900; _i <= 0x097F; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.L2R_DEVANAGARI;
	} //Hindi block
	for (var _i = 0xFB50; _i <= 0xFDFF; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.R2L_ARABIC;
	} //Arabic presentation forms A
	for (var _i = 0xFE70; _i <= 0xFEFF; _i++) {
		_map[? _i] = __SCRIBBLE_BIDI.R2L_ARABIC;
	...
	for (var _i = 0x0E01; _i <= 0x0E2F; _i++) {
		_map[? _i] = true;
	}
	_map[? 0x0E30] = true;
	_map[? 0x0E40] = true;
