...
function InputTriggerEffectVibration(
	_trigger,
	_position,
	_amplitude,
	_frequency,
	...
	_playerArray[_playerIndex].__SetTriggerEffect(
		_trigger,
		new __InputTriggerEffectClassVibration(_position, _amplitude, _frequency),
		true
	);
}
