					...
					if (is_undefined(_child_struct)) {
						...
						repeat (array_length(_child_names_array)) {
							...
							if (_child_name == "font") {
								...
								(_child_name == "color") || (_child_name == "scale")
							) {
								if (
									!is_numeric(_child_value)
									&& !is_undefined(_child_value)
								) {
									__scribble_error(
								...
								(_child_name == "bold") || (_child_name == "italic")
							) {
								...
								(_child_name == "prefix") || (_child_name == "suffix")
							) {
								if (
									!is_string(_child_value)
									&& !is_undefined(_child_value)
								) {
									__scribble_error(
										"Child struct property \"",
