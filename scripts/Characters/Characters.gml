...
function get_character(
	...
	var variant = struct_exists(character, "variants") && struct_exists(character.variants, character_data)
	...
	return {
		...
		name_color: hex_to_color(struct_get_merged_value(
			queue,
			"name_color"
		)),
		text_color: hex_to_color(struct_get_merged_value(
			queue,
			"text_color"
		)),
