...
function get_character(character_id = undefined) {
    ...
    return {
        name: struct_exists(character, "name") ? character.name : global.character_defaults.name,
        name_color: struct_exists(character, "name_color") ? character.name_color : global.character_defaults.name_color,
