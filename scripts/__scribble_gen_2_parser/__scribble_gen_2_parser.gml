				...
				if (_tag_open_count <= 0) {
					...
					switch (_command_tag_lookup_accelerator_map[? _tag_command_name]) {
						...
						case 28:
							...
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__MATERIAL] =
								__scribble_surface_get_material(_surface);
							_glyph_grid[#
								_glyph_count,
						...
						case 40: // [texture,<index>,<x>,<y>,<w>,<h>]
							...
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__MATERIAL] =
								__scribble_texture_get_material(_tex_index);
							...
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__QUAD_U0] =
								_u0;
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__QUAD_U1] =
								_u1;
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__QUAD_V0] =
								_v0;
							_glyph_grid[# _glyph_count, __SCRIBBLE_GEN_GLYPH.__QUAD_V1] =
								_v1;
						...
						default:
							...
							if (ds_map_exists(_effects_map, _tag_command_name)) {
								...
								var _sprite_index =
									_external_sprite_map[? _tag_command_name]
									?? asset_get_index(_tag_command_name);
								if ((!sprite_exists(_sprite_index)) && _useHandleParse) {
								...
								if (sprite_exists(_sprite_index)) {
									...
									if (
										sprite_exists(_sprite_index)
										&& (
											(!SCRIBBLE_USE_SPRITE_WHITELIST)
												|| (
													_sprite_whitelist_map[? _sprite_index]
														?? false
												)
										)
									) {
									...
									asset_get_type(_tag_command_name) == asset_sound
								) {
									_control_grid[#
										_control_count,
										__SCRIBBLE_GEN_CONTROL.__TYPE
