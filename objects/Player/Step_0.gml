...
if (horizontal_vector != 0 or vertical_vector != 0)
{
    ...
    if (animation_clock >= animation_speed) {
        if (vertical_vector > 0) {
            ...
            if (image_index == 9) image_index = 11 else image_index = 9;
        }
        else if (horizontal_vector > 0) {
            if (image_index == 6) image_index = 8 else image_index = 6;
        }
        else if (horizontal_vector < 0) {
            if (image_index == 3) image_index = 5 else image_index = 3;
        }
        animation_clock = 0;
    }
}
else
{
    ...
    if (image_index >= 3 && image_index < 5) image_index = 4;
    if (image_index >= 5 && image_index < 9) image_index = 7;
